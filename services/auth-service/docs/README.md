...
启动服务后，访问：**http://localhost:8081/swagger/index.html**
...
- `POST /api/v1/auth/prelogin` - 预登录（生成 state）
...
// @Success 200 {object} dto.Response{data=ResponseDTO} "成功描述"
// @Failure 400 {object} dto.Response "失败描述"
